...
const  Prospect = ({text}) => {
    ...
    return (
        <div className='container mx-auto pt-16 pb-24 px-5 relative w-full md:px-20'>
                ...
                <div className='w-full p-6 flex max-h-auto gap-12 rounded-[32px] bg-white sm:p-8' style={{ backgroundImage: "url('/assets/texture-prospect.png')", backgroundSize: "cover", backgroundPosition: "center" }}>
                    ...
                    <div className='flex flex-col justify-center text-[#02264A] w-full lg:w-8/12'>
                        ...
                        <div className='flex items-center mt-8 gap-4'>
                            <button
                                className="px-8 py-4 w-fit bg-[#FFCC00] tracking-wide mt-2 text-base text-[#252525] font-semibold rounded-3xl transition-all duration-300 hover:bg-yellow-500 hover:text-black"
                            >
                                {langs ? "Explore Our Program" : "Jelajahi Program Kami"}
                            </button>
                            <button
                                className="px-8 py-4 w-fit border-2 border-[#AFB8CA] tracking-wide mt-2 text-base text-[#252525] font-semibold rounded-3xl transition-all duration-300 hover:bg-yellow-500 hover:text-black"
                            >
