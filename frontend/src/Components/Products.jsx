        ...
        <div className="container min-h-screen mx-auto px-10" id="products">
            <Col gutter={[50, 20]} className="py-24 px-0" justify='center' align='middle'>
                ...
                <div className="flex flex-col w-full mt-8">
                    <div className="flex mb-6 text-white items-center justify-between bg-[#181B3F] w-full rounded-xl p-14 px-16">
                    ...
                    <div className="flex text-white items-center justify-between bg-[#181B3F] w-full rounded-xl p-14 px-16">
                        <div className="flex flex-col justify-between tracking-wide text-justify w-6/12">
                        ...
                        <div className="flex justify-end w-4/12">
                            <img src="/assets/product(2)x2.png" className="" alt="" />
                        </div>
                    </div>
                </div>
            </Col>
