...
const Tags = ({text}) => {
      ...
      const observer = new IntersectionObserver(
        (entries) => {
          ...
          if (entry.isIntersecting && !startAnimation) {
            ...
            animateNumber(500, setRegistrant, 2000);
  ...
  return (
    <div ref={sectionRef} className='container mx-auto mb-24 mt-16 md:mt-16 relative w-full px-5'>
