...
const Tags = ({text}) => {
  ...
  return (
    <div ref={sectionRef} className='container mx-auto mb-24 -mt-12 relative w-full'>
                ...
                <div className='flex justify-between items-center text-white w-full'>
                    <span className='flex w-4/12 justify-start'>
                        ...
                        <div className='flex flex-col ml-4 justify-evenly'>
                            <h2 className="font-bold text-4xl">{registrant}+</h2>
                            <h4 className='tracking-wide text-md'>{text.regist}</h4>
                        </div>
                    </span>
                    <span className='flex w-4/12 justify-center'>
                        ...
                        <div className='flex flex-col ml-4 justify-evenly'>
                            <h2 className="font-bold text-4xl">{happyParticipants}%</h2>
                            <h4 className='tracking-wide text-md'>{text.participants}</h4>
                        </div>
                    </span>
                    <span className='flex w-4/12 justify-end'>
                        ...
                        <div className='flex flex-col ml-4 justify-evenly'>
                            <h2 className="font-bold text-4xl">{skillsEnhancement}%</h2>
                            <h4 className='tracking-wide text-md'>{text.skill}</h4>
                        </div>
                    </span>
                </div>
            </div>
