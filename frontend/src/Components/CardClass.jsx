...
const CardClasses = ({ data }) => {
  ...
  return (
    <Link to="https://wa.link/4hhjtd" target="_blank">
      <div className="transition ease-in bg-white rounded-2xl text-[#02264A] min-h-[320px] w-full drop-shadow-md overflow-hidden">
        <img
        ...
        <div className="px-6 py-4">
          ...
          <div className="flex justify-between items-center mt-4">
            ...
            <div className=" flex items-center">
              {renderLevel()}
              <h4 className="text-sm font-medium text-gray-500 ml-2"></h4>
            </div>
          </div>
        </div>
      </div>
