      ...
      ? [
          {
            ...
            desc: "Create inspiring content during their time as awardees in China to motivate young Indonesians to pursue their dreams of studying there.",
          },
          {
            title: "Mandarin Tutor",
            desc: "Make a real impact by teaching in the Mandarin learning community established by Active Mandarin.",
          },
          {
            title: "Active Participation in Active Mandarin Activities",
            desc: "Alumni will stay involved in various programs and events, sharing experiences and contributing to the community’s growth.",
          },
        ]
      : [
          {
            title: "Pembuat Konten Edukasi",
            desc: "Membuat konten inspiratif selama masa beasiswa di China untuk memotivasi generasi muda Indonesia mengejar impian belajar di sana.",
          },
          {
            title: "Pengajar Bahasa Mandarin",
            desc: "Memberikan dampak nyata dengan mengajar di komunitas pembelajar bahasa Mandarin yang dibangun oleh Active Mandarin.",
          },
          {
            title: "Partisipasi Aktif dalam Kegiatan Active Mandarin",
            desc: "Alumni akan tetap terlibat dalam berbagai program dan acara, berbagi pengalaman, dan berkontribusi pada pertumbuhan komunitas.",
          },
        ];
  }, [langs]);
  ...
  return (
    <Mainlayouts className="bg-background" footerClassName="bg-background">
      <div className="container flex flex-col mx-auto px-5 py-5 gap-16 md:px-[72px] md:py-16 lg:flex-row">
        <div className="w-full lg:w-[57%]">
          ...
          <div className="flex items-center justify-center mt-8 gap-4 md:justify-start">
            <a href="#Apply">
              <button className="px-6 py-3 md:px-8 md:py-4 w-fit bg-[#FFCC00] tracking-wide mt-2 text-xs text-[#252525] font-semibold rounded-3xl transition-all duration-300 hover:bg-yellow-500 hover:text-black sm:text-sm lg:text-base">
                {langs ? "Donate Now" : "Donasi Sekarang"}
              </button>
            </a>
            <a href="#Banner">
              <button className="px-6 py-3 md:px-8 md:py-4 w-fit border-2 border-[#8493AC] tracking-wide mt-2 text-xs text-[#252525] font-semibold rounded-3xl transition-all duration-300 hover:bg-yellow-500 hover:text-black sm:text-sm lg:text-base">
        ...
        <div className="grid grid-cols-12 mt-8 w-full gap-8">
          <div className="flex gap-4 w-full p-4 rounded-2xl bg-white col-span-12">
            ...
            <div className="w-full">
              <h3 className="text-xl text-[#2B313B] font-semibold">
                Awardee Impact
              </h3>
      ...
      <div className="container flex flex-col mx-auto px-5 py-5 items-start md:px-[72px] md:py-16">
        ...
        <img
          src="/assets/donate-banner.png"
          alt="donate banner"
          className="w-full h-fit mt-8 rounded-3xl"
          id="Banner"
        />
      </div>
