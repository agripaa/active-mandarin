  ...
  return (
    <div>
      <div className="bg-white rounded-2xl border border-neutral-300 flex flex-col w-full h-full relative">
        ...
        <span className={`absolute bottom-[45%] right-2 ${item.type_product == "fisik" ? "bg-[#FFCC00] text-black" : "bg-blue-500 text-white"} text-sm font-medium py-1 px-3 rounded-2xl`}>
