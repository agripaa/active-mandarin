...
import ExamTable from '../Components/dashboard/DashboardExamTable';
        ...
        <DashboardLayout>
            <section className='flex flex-col'>
                    ...
                    <div className="w-full md:w-[70%]">
                        ...
                        >
                            <div className="flex justify-between items-center mb-4">
                                <h2 className="text-lg font-semibold">Performa Pendapatan</h2>
                                <select 
                ...
                <div className='flex w-full min-h-[480px] gap-4 p-4'>
                    <ExamTable dataProgram={programList} />
                </div>
            </section>
        </DashboardLayout>
    );
