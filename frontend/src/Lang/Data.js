export const EngLang = {
    navbar: ['Home', 'About', 'Class', 'Events', 'Flash Card'],
    getStarted: 'Get Started',
    herosTitle: 'Be Active With Active Mandarin',
    herosDesc: 'More practice more result',
    sponsorsTags: 'Trusted by several companies',
    ...
    productsTitle: 'Active Mandarin ID Products',
    productsTags: 'Get your free service wherever you go, whatever you want',
    productsDesc: 'With Active Mandarin ID, achieve your dream to study at the Top Universities in China, Hong Kong, and Taiwan.',
    productItem: [
        'Our career center will give you a lot of insight about working in the mandarin industry in any fields.',
        'Flashcard Mandarin simplified and traditional'
    ],
    classTitle: 'Choose your package',
    classButton: 'View more',
    classPageTitle: 'Catalog Class',
    classPageDesc: "Let’s do the placement test",
    lectureTitle: 'GET TO KNOW',
    lectureTags: 'Our experience and professional mentor in Active',
    momentsTitle: 'Moments',
    momentsTags: 'Our memory during the program',
    testimonyTitle: 'TESTIMONY',
    testimonyTags: 'What did the students say to us?',
    eventTitle: 'Upcoming Event',
    eventTags: 'Join with Us',
    eventDesc: 'Follow our social media to get know more about the program we have',
    viewButton: 'View More',
    faqTitle: 'Nice to meet you change to → Happy Learning, 加油!',
    faqTags: 'Frequently Asked Questions',
    donateTitle: 'Give',
...
export const IndLang = {
    navbar: ['Beranda', 'Tentang', 'Kelas', 'Acara', 'Flash Card'],
    getStarted: 'Mulai',
    herosTitle: 'Belajar Minimal, Hasil Optimal',
    herosDesc: 'Mau mandarinmu makin hebat? belajar di Active pasti tepat!',
    sponsorsTags: 'Dipercaya oleh',
    sponsorsCTA: 'Informasi kerja sama',
    workflowTitle: 'Kenapa Harus Active Mandarin?',
    workflowCards: [
        {
    ...
    productsTitle: 'Produk Active Mandarin ID',
    productsTags: 'Dapatkan layanan gratis yang bisa diakses kapanpun dan dimanapun',
    productsDesc: 'Bersama Active Mandarin ID wujudkan mimpimu untuk raih beasiswa luar negeri di kampus impianmu di China, Hong Kong, dan Taiwan.',
    productItem: [
        'Career Center Program akan bantu wujudkan mimpimu mendapatkan prospek kerja yang lebih terjamin.',
        'Flashcard Mandarin simplified and traditional.'
    ],
    classTitle: 'Pilih paket kelas yang kamu inginkan',
    ...
    lectureTitle: ' Kenalan, yuk!',
    lectureTags: 'Tutor Active Mandarin ID',
    momentsTitle: 'Momen',
    momentsTags: 'Memori kegiatan program Active',
    testimonyTitle: 'Ulasan',
    testimonyTags: 'Simak kata mereka tentang Active Mandarin ID, yuk!',
    eventTitle: 'Program Mendatang',
    eventTags: 'Gabung',
    ...
    socmed: 'Media Sosial',
    general: 'Umum',
    generalItem: ['Tentang Kami', 'Karir'],
    help: 'Pusat Bantuan',
