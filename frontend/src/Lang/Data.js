export const EngLang = {
    navbar: ['Home', 'About Us', 'Class', 'Contact Us'],
    getStarted: 'Get Started',
    herosTitle: 'Be Active With Active Mandarin',
    herosDesc: 'Active Mandarin is a platform focused on mandarin education, mentorship and career.',
    herosActionDesc: 'Join now and get your:',
    herosListInformation: ['Edication', 'Career Center', 'Study Aboard Mentorship', 'Flashcard HSK'],
    ...
    productsDesc: 'to support your learning in understanding Mandarin',
    productItem: [
    ...
    quotes: 'Nice to meet you change to → Happy Learning, 加油!',
    faqTags: 'One language sets you in a corridor for life. Two languages open every door along the way.',
    donateTitle: 'Give',
...
export const IndLang = {
    ...
    herosDesc: 'Active Mandarin adalah platform yang berfokus pada pendidikan, bimbingan, dan karier bahasa Mandarin.',
    herosActionDesc: 'Bergabunglah sekarang dan dapatkan:',
    herosListInformation: ['Pendidikan', 'Pusat Karir', 'Belajar di Luar Pendampingan', 'Flashcard HSK'],
    ...
    productsTitle: 'Produk Baru Kami',
    productsDesc: 'untuk menunjang pembelajaran anda dalam memahami bahasa mandarin.',
    productItem: [
