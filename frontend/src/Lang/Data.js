export const EngLang = {
    ...
    donationBtn: 'Support Now',
    navbar: ['Home', 'About Us', 'Our Programs', 'Our Products'],
    getStarted: 'Get Started',
    herosTitle: 'Transform Your Future with Active Mandarin Indonesia',
    herosDesc: 'Active Mandarin Indonesia is a platform focused on Education, Mentor Scholarship and Career Center. Join us today to achieve a Bright Future by Studying at a Top University in China! 🇨🇳✨',
    ...
    productsTitle: 'Just Released',
    productsDesc: 'Find the premium class and opportunities along the way',
    ...
    testimonyTags: 'Join Our Growing Community',
    ...
    phoneTitle: 'Phone Number & Whatsapp',
    socmed: 'Social Media',
    general: 'General',
...
export const IndLang = {
    ...
    navbar: ['Beranda', 'Tentang Kami', 'Program Kami', 'Produk Kami'],
    getStarted: 'Mulai',
    herosTitle: 'Ubah Masa Depan Anda dengan Active Mandarin Indonesia',
    herosBtn: "Jelajahi Program Kami",
    herosDesc: 'Active Mandarin Indonesia adalah platform yang berfokus pada Pendidikan, Beasiswa Mentor, dan Pusat Karir. Bergabunglah dengan kami hari ini untuk meraih Masa Depan Cerah dengan Belajar di Universitas Terbaik di Tiongkok! 🇨🇳✨',
    ...
    productsTitle: 'Baru Rilis',
    productsDesc: 'Temukan kelas premium dan peluang di sepanjang jalan',
    ...
    testimonyTags: 'Bergabunglah dengan Komunitas Kami yang Berkembang',
    ...
    addressTitle: 'Alamat',
    phoneTitle: 'Nomor Telepon & Whatsapp',
    socmed: 'Media Sosial',
    general: 'Umum',
